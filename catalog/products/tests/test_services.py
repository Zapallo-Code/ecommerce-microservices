...
class ProductServiceTest(TestCase):
    ...
    def test_get_random_product_success(self):
        """Test get_random_product returns product successfully."""
        # Create mock product
    ...
    def test_get_random_product_no_products(self):
        """Test get_random_product when no products available."""
    ...
    def test_get_random_product_database_error(self):
        """Test get_random_product raises DatabaseError."""
        self.mock_repository.get_random_active_product.side_effect = DatabaseError("DB connection failed")
        
        with self.assertRaises(DatabaseError):
            self.service.get_random_product()
    
    def test_get_random_product_unexpected_error(self):
        """Test get_random_product raises unexpected exception."""
        self.mock_repository.get_random_active_product.side_effect = Exception("Unexpected error")
        
        with self.assertRaises(Exception):
            self.service.get_random_product()
    
    def test_service_uses_default_repository(self):
        """Test service creates default repository when none provided."""
